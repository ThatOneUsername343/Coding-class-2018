...
namespace Binary_Trees
{
    ...
    class BinaryTreePrinter
    {
        public static void printNode(Node1 root)
        {
            ...
            printNodeInternal(new List<Node1>() { root }, 1, maxLevel);
        }

        private static void printNodeInternal(List<Node1> nodes, int level, int maxLevel)
        {
            ...
            List<Node1> newNodes = new List<Node1>();
        ...
        private static int maxLevel(Node1 node)
        {
            if (node == null)
                return 0;
        ...
        private static bool isAllElementsNull(List<Node1> list)
        {
