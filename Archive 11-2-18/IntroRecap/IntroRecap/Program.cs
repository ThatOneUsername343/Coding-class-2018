...
namespace IntroRecap
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string name = "Ryan Alexander Moore";
            ...
            {
                Console.WriteLine("IsValid not true");
            }
            ...
            int index = 0;
            //while index < 10 Console increment index
            while (index < 10)
            {
            ...
            index = 0;
            //while index < 0 console increment index
            while (index < 0)
            {
                Console.WriteLine(index);
                index++;
            ...
            //Reset index variable to 0
            index = 0;
            //do-while index < 10 console increment index
            do
            {
                Console.WriteLine(index);
                index++;
            ...
            //reset index variable to 0
            index = 0;
            //do-while index < 0 console increment index
            do
            {
                Console.WriteLine(index);
                index++;
            ...
            stringArray[0] = "Ryan, Moore, Colorado Springs, Colorado, 'Murica";
            stringArray[1] = "Ryan, Moore, Colorado Springs, Colorado, 'Murica";
            stringArray[2] = "Ryan, Moore, Colorado Springs, Colorado, 'Murica";
            stringArray[3] = "Ryan, Moore, Colorado Springs, Colorado, 'Murica";
            stringArray[4] = "Ryan, Moore, Colorado Springs, Colorado, 'Murica";
            ...
            {
                stringArray[i] = ("The current index is " + i + " where i is the actualy value of i");
            }
